...
if (isset($_POST['about_us_page'])) {
    ...
    if ($settings_edit) {
        ...
        echo '<script>window.location.href = "footer_setting.php";</script>';
    } else {
    ...
    <ul id="sidebar_menu">
        ...
        <li class="mm-active">
            ...
            <ul>
                ...
                <li><a href="footer_setting.php" class="active">Footer Setting</a></li>
                                            ...
                                            <div class="form-group mt-4 row">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="fileupload_block">
                                                        ...
                                                        <img type="logo" style="object-fit:cover;" src="images/footer/<?php echo $data['logo']; ?>" alt="logo" />
