 ...
 <div class="footer_area sixteen position-relative pd_left_100 pd_right_100  md_pd_left_15 md_pd_right_15"
     ...
     <div class="inner_section">
         <div class="footer_widgets_wrap bg_op_1 rounded_radius"
             style="background: url(assets/images/home-16-footer-bg.jpg);">
             <!--===============spacing==============-->
                                 ...
                                 <div class="foo_cont_inner">
                                     ...
                                     <div class="bottom">
                                         ...
                                         <div class="con_content">
                                             <h5> Phone :</h5>
                                             <a href="tel:+98 060 712 34" class="color_white">
                                                 <?php echo $contact['phone']; ?></a>
                                         </div>
                                         <div class="con_content">
                                             <h5> Mail Us :</h5>
                                             <a href="mailto:sendmail@creote.com" class="color_white">
             ...
             <div class="default-container">
                 <div class="row align-items-center">
                     <div class="col-lg-2 col-md-12">
                         <div class="footer_logo">
                             <a href="index.html" class="logo navbar-brand">
                                 <img decoding="async" src="assets/images/logo-default.png" alt="Creote"
                                     class="logo_default" />
                             </a>
                         </div>
                     </div>
                     <div class="col-lg-6 col-md-12">
                         <div>
                             © 2023 <a href="https://themeforest.net/user/steelthemes">Trading.</a> 
                             Designed and Developed by RndTechnosoft.
                         </div>
                     </div>
