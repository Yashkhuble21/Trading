                            ...
                            <div class="col-lg-12 mb-3 ">
                                <div class="title_all_box style_one text-center dark_color">
                                    <div class="title_sections">
                                        <h6 class="color-title" style="color:#078586;">Get Best Quotation</h6>
                                        <div class="before_title description_buyer"
                                            style="color:#282f3b;text-decoration:none;padding:2px 15px;">Choose from a
                                            wide range of Raw Material Categories and Get the right material in the
                                            size, finish, and quantity you need - when you need it.</div>
                                    </div>
                                    <!--===============spacing==============-->
                            ...
                            <div class="col-xl-6 col-lg-12 mb-sm-5 mb-md-5 mb-lg-5 mb-xl-0">
                                ...
                                <div class="title_all_box style_five  dark_color">
                                    <div class="title_sections five left">
                                        ...
                                        <h2>Why Buying from Ofbusiness is beneficial?</h2>
                                ...
                                <div class="content_box_cn style_one">
                                    <div class="txt_content">
                                        <h5>Lowest Quotations for all Raw Materials</h3>
                                    </div>
                                </div>
                                <!--===============spacing==============-->
                                <div class="pd_bottom_20"></div>
                                ...
                                <div class="content_box_cn style_one">
                                    <div class="txt_content">
                                        <h5>Credit Facilities Available for Purchases</h3>
                                    </div>
                                </div>
                                <!--===============spacing==============-->
                                <div class="pd_bottom_20"></div>
                                ...
                                <div class="content_box_cn style_one">
                                    <div class="txt_content">
                                        <h5>Widest Range of Raw Materials</h5>
                                    </div>
                                </div>
                                <!--===============spacing==============-->
                                <div class="pd_bottom_20"></div>
                                ...
                                <div class="content_box_cn style_one">
                                    <div class="txt_content">
                                        <h5>Stringent Quality Assurance of Deliveries</h5>
                                    </div>
                                </div>
                                <!--===============spacing==============-->
                                <div class="pd_bottom_20"></div>
                                ...
                                <div class="content_box_cn style_one">
                                    <div class="txt_content">
                                        <h5>In-App Tracking of Orders</h5>
                                    </div>
                                </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <label> Phone Number<br>
                                                                    <span class="wpcf7-form-control-wrap"
                                                                        data-name="tel-922"><input type="tel"
                                                                            name="tel-922" value="" size="40"
                            ...
                            <div class="col-lg-12">
                                <div class="title_all_box style_two text-center dark_color">
                                    <div class="title_sections two">
                                        ...
                                        <p>Check our FAQs for quick answers to frequently asked questions we
                                            receive.<br> If you
                                            have
                                ...
                                <div class="faq_section type_one">
                                    <div class="block_faq">
                                        <div class="accordion">
                                            <dl>
                                                <dt class="faq_header">
                                                    <span class="icon-play"></span> What sectors or industries do you
                                                    recruit for?
                                                </dt>
                                                <dd class="accordion-content hide">
                                                    <p>
                                                        ...
                                                        which is the
                                                        same as saying through shrinking. Nor again is there anyone who
                                                        loves or
                                                        pursues or desires to obtain pain itself is pains but
                                                        circumstances great
                                                    </p>
                                                </dd>
                                                <dt class="faq_header">
                                                    <span class="icon-play"></span> What recruitment services do you
                                                    offer?
                                                </dt>
                                                <dd class="accordion-content hide">
                                                    <p>
                                                        ...
                                                        Retailer For The
                                                        People, Focusing On The Promotion Of Sustainable Living,
                                                        Renewable Energy
                                                        Production And Smart Energy Grid Utility Services.
                                                    </p>
                                                </dd>
                                                <dt class="faq_header">
                                                    <span class="icon-play"></span> Where will you advertise my job
                                                    vacancy?
                                                </dt>
                                                <dd class="accordion-content hide">
                                                    <p>
