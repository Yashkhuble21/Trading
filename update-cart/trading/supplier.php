    ...
    <div id="page" class="page_wapper hfeed site">
        ...
        <div id="wrapper_full" class="content_all_warpper">
            ...
            <div id="content" class="site-content ">
                            ...
                            <div class="col-lg-12 mb-3 ">
                                <div class="title_all_box style_one text-center dark_color">
                                    <div class="title_sections">
                                        <h6 class="color-title" style="color:#078586;">Partner with Us</h6>
                                        <div class="before_title description_buyer" style="color:#282f3b;text-decoration:none;padding:2px 15px;">Acquire more business and increase exposure to OFBusiness’s customer network and receive requests for quotation within your specified locations
                                        </div>
                                    </div>
                                    <!--===============spacing==============-->
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                <div class="process_box style_four dark_color">
                                    <div class="process_box_outer_four ">
                                        <div class="icon">
                                            <img src="assets/images/service-ico-3.png" class="img-fluid svg_image" alt="icon png">
                                            <h6> 01</h6>
                                        </div>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                ...
                                <div class="process_box style_four dark_color">
                                    <div class="process_box_outer_four ">
                                        <div class="icon">
                                            <img src="assets/images/process-icon-im-1.png" class="img-fluid svg_image" alt="icon png">
                                            <h6>02</h6>
                                        </div>
                                        <div class="content_box">
                                            <h5>High Order Volume</h5>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                <div class="process_box style_four dark_color">
                                    <div class="process_box_outer_four ">
                                        <div class="icon">
                                            <img src="assets/images/service-ico-2.png" class="img-fluid svg_image" alt="icon png">
                                            <h6> 03</h6>
                                        </div>
                                        <div class="content_box">
                                            <h5>Bigger Client Base
                                            </h5>
                ...
                <!----contact---->
                <section class="contact-section bg_op_1" style="background: url(assets/images/contact-bg-6.jpg);">
                    <!--===============spacing==============-->
                    <div class="pd_top_80"></div>
                    <!--===============spacing==============-->
                            ...
                            <div class="col-xl-6 col-lg-12 mb-sm-5 mb-md-5 mb-lg-5 mb-xl-0">
                                ...
                                <div class="title_all_box style_five  dark_color">
                                    <div class="title_sections five left">
                                        ...
                                        <h2>Why Partnering with OfBusiness is a smart move?</h2>
                                ...
                                <div class="content_box_cn style_one">
                                    <div class="txt_content">
                                        <h5>Get unlimited Enquiries from Pan India</h3>
                                    </div>
                                </div>
                                <!--===============spacing==============-->
                                <div class="pd_bottom_20"></div>
                                ...
                                <div class="content_box_cn style_one">
                                    <div class="txt_content">
                                        <h5>Dedicated Portal for Tracking</h5>
                                    </div>
                                </div>
                                <!--===============spacing==============-->
                                <div class="pd_bottom_20"></div>
                                ...
                                <div class="content_box_cn style_one">
                                    <div class="txt_content">
                                        <h5>Hassle-Free Registration Process</h5>
                                    </div>
                                </div>
                                <!--===============spacing==============-->
                                <div class="pd_bottom_20"></div>
                                ...
                                <div class="content_box_cn style_one">
                                    <div class="txt_content">
                                        <h5>Logistics Support for Deliveries</h5>
                                    </div>
                                </div>
                                ...
                                <div class="content_box_cn style_one">
                                    <div class="txt_content">
                                        <h5>Get Access to 10 Lakh+ SMEs</h5>
                                    </div>
                                </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <label> Phone Number<br>
                                                                    <span class="wpcf7-form-control-wrap" data-name="tel-922"><input type="tel" name="tel-922" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-tel wpcf7-validates-as-tel" aria-invalid="false" placeholder="Enter Your Number"></span><br>
                                ...
                                <div class="faq_section type_one">
                                    <div class="block_faq">
                                        <div class="accordion">
                                            <dl>
                                                <dt class="faq_header">
                                                    <span class="icon-play"></span> What sectors or industries do you recruit for?
                                                </dt>
                                                ...
                                                <dt class="faq_header">
                                                    <span class="icon-play"></span> What recruitment services do you offer?
                                                </dt>
                                                <dd class="accordion-content hide">
                                                    <p>
                                                ...
                                                <dt class="faq_header">
                                                    <span class="icon-play"></span> Where will you advertise my job vacancy?
                                                </dt>
                                                <dd class="accordion-content hide">
                                                    <p>
                                                        Serenity Is Multi-Faceted Blockchain Based Ecosystem, Energy Retailer For The
                                                ...
                                                <dt class="faq_header active">
                                                    <span class="icon-play"></span> How can I register a job?
                                                </dt>
